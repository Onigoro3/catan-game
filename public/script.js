...
function render(){
    ...
    hexes.forEach(h=>{
        ...
        if(s>15){
            ...
            if(h.number!==null && h.number!==0) drawNumberToken(p.x,p.y,h.number,s); // ★修正
        }
